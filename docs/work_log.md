...
### 已就绪
（同 08-06，未变——见上方"历史状态（2026-08-06）"完整列表。另加：`FIRST_MESSAGE_TEMPLATE` 已从方案 B 改回方案 A，本地验证通过）
...
### 产出
- `scripts/prepare_openclaw_test_scripts.sh`：`FIRST_MESSAGE_TEMPLATE` 从方案 B 改回方案 A
- 详细核实过程见 [`issues_log.md`](issues_log.md) 2026-08-07 条目

### 未验证
- [ ] 方案 A 能否避免"格式癫痫+拒写"这个新失效模式（已实现，待真实训练验证）
